package com.dh.proyecto_integrador_testing.testBack;
...
public class BackendTest {
    ...
    static ExtentSparkReporter info = new ExtentSparkReporter("target/backend-report.html");
    ...
    public void descargaDeFondos() {
        ...
        given()
                .auth()
                .basic(username, password)
                .post(urlBase + "transfer?fromAccountId="+accountId+ "&toAccountId=15454&amount=" + amount)
                .then()
                .statusCode(200)
                .log().status()
                .log().body();
